...
namespace proto_msg {
class LidarScanDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<LidarScan> {
...
void TableStruct::Shutdown() {
  _LidarScan_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _LidarScan_default_instance_.DefaultConstruct();
}
...
LidarScan::LidarScan()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_scan_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* LidarScan::descriptor() {
  ...
  return protobuf_scan_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata LidarScan::GetMetadata() const {
  protobuf_scan_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_scan_2eproto::file_level_metadata[0];
}
