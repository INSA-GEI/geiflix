...
namespace proto_msg {
class LidarPacketDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<LidarPacket> {
...
void TableStruct::Shutdown() {
  _LidarPacket_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _LidarPacket_default_instance_.DefaultConstruct();
}
...
const ::google::protobuf::Descriptor* LidarPacket::descriptor() {
  ...
  return protobuf_packet_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata LidarPacket::GetMetadata() const {
  protobuf_packet_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_packet_2eproto::file_level_metadata[0];
}
